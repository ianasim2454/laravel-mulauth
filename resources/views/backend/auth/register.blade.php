<!DOCTYPE html>
<html lang="en"><!-- Mirrored from www.masta.com.mx/Diseno_brandcheck/horizontal/authentication-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Jul 2024 05:24:01 GMT --><head>
	<!-- Required meta tags -->
	<meta charset="utf-8">
						...
						<div class="card">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<div class="form-body">
										<form action="{{route('dashboard')}}" class="row g-3" method="post">
                                            @csrf
											<div class="col-sm-12">
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="text" class="form-control border-end-0"  name="password_confirmation"id="inputConfirmPassword" value="" placeholder="Confirm Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>
												</div>
											</div>
